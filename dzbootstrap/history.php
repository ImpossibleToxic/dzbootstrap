...
<head>
    ...
    <title>История музея</title> <!-- Заголовок страницы, отображаемый в вкладке браузера -->
...
<body>
    ...
    <div class="container"> <!-- Контейнер Bootstrap для центрирования содержимого и задания отступов -->
        <h1>История музея</h1> <!-- Заголовок первого уровня для раздела "История музея" -->
        <p>Музей радиоаппаратуры был основан в 2020 году с целью сохранить и популяризировать историю радиосвязи и радиоаппаратуры.</p> <!-- Параграф с информацией об основании музея -->
        <p>За годы работы музей собрал уникальную коллекцию экспонатов, которая продолжает расти благодаря поддержке наших посетителей и партнеров.</p> <!-- Параграф с информацией о коллекции музея и его развитии -->
        <img src="assets/img/history.jpg" alt="История музея" class="img-fluid"> <!-- Изображение с классом Bootstrap для адаптивности (изображение будет масштабироваться) -->
    </div>
