...
<nav class="navbar navbar-expand-lg navbar-light bg-light"> <!-- Создает навигационную панель с использованием классов Bootstrap -->
    ...
    <div class="container"> <!-- Контейнер Bootstrap для центрирования содержимого и задания отступов -->
        <h1>Контакты</h1> <!-- Заголовок первого уровня для раздела "Контакты" -->
        <p>Email: info@museum.com</p> <!-- Параграф с адресом электронной почты музея -->
        <p>Телефон: +7 (123) 456-78-90</p> <!-- Параграф с номером телефона музея -->
        <img src="assets/img/contacts.jpg" alt="Контакты" class="img-fluid"> <!-- Изображение с классом Bootstrap для адаптивности (изображение будет масштабироваться) -->
    </div>
